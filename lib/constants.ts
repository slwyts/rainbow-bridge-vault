...
const chainConfigs: Record<number, ChainConfig> = {
  ...
  [CHAIN_IDS.XLAYER]: {
    ...
    name: "X Layer",
    warehouseAddress: process.env
      .NEXT_PUBLIC_XLAYER_WAREHOUSE_ADDRESS as `0x${string}`,
    tokens: {
  ...
  [CHAIN_IDS.BSC]: {
    ...
    name: "BSC",
    warehouseAddress: process.env
      .NEXT_PUBLIC_BSC_WAREHOUSE_ADDRESS as `0x${string}`,
    tokens: {
  ...
  [CHAIN_IDS.ARBITRUM]: {
    ...
    name: "Arbitrum",
    warehouseAddress: process.env
      .NEXT_PUBLIC_ARB_WAREHOUSE_ADDRESS as `0x${string}`,
    tokens: {
...
export const ENV = {
  LOCALNET_WAREHOUSE_ADDRESS: process.env
    .NEXT_PUBLIC_LOCALNET_WAREHOUSE_ADDRESS as `0x${string}`,
  LOCALNET_USDT_ADDRESS: process.env
    .NEXT_PUBLIC_LOCALNET_USDT_ADDRESS as `0x${string}`,
  LOCALNET_USDC_ADDRESS: process.env
    .NEXT_PUBLIC_LOCALNET_USDC_ADDRESS as `0x${string}`,
  LOCALNET_XWAIFU_ADDRESS: process.env
    .NEXT_PUBLIC_LOCALNET_XWAIFU_ADDRESS as `0x${string}`,
